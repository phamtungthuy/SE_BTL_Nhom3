        ...
        return (
            <div id="auswertung-result" class="col-md-6" style={{ display: "block" }}><h3>Kết quả</h3>
                <table class="table table-striped" id="result-table">
                    <tbody>
                        <tr><td id="wpm" class="name" colspan="2" title="Words per Minute: 1 word equals 5 keystrokes"><strong>{Math.floor(this.props.correctWords * 60 / defaultTime)} WPM</strong><small>(words per minute)</small></td></tr>
