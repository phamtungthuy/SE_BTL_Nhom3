...
<table class="table table-striped" id="result-table">
    <tbody>
		<tr><td id="wpm" class="name" colspan="2" title="Words per Minute: 1 word equals 5 keystrokes"><strong>77 WPM</strong><small>(words per minute)</small></td></tr>
		...
		<tr id="accuracy"><td class="name">Độ chính xác</td><td class="value"> <strong>70.88%</strong></td></tr>
		<tr id="correct"><td class="name">Những từ đúng</td><td class="value"> <strong>74</strong></td></tr>
		<tr id="wrong"><td class="name">Những từ sai</td><td class="value"> <strong>7</strong></td></tr>
		<tr>
